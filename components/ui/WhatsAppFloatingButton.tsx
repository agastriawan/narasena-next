...
export function WhatsAppFloatingButton({ 
  className, 
  message = 'Halo Nara Sena, saya ingin konsultasi mengenai kebutuhan signage saya.' 
}: WhatsAppFloatingButtonProps) {
  const whatsappUrl = formatWhatsAppLink(CONTACT_INFO.whatsapp, message);
  ...
  return (
    ...
    >
      <svg className="h-7 w-7 md:h-8 md:w-8 fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
