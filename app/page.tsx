...
export default function HomePage() {
  return (
    <>
      {/* Hero Section */}
      <section id="hero" className="relative flex min-h-[100svh] items-center overflow-hidden bg-navy py-20 md:py-0">
        {/* Background Elements */}
        ...
        <div className="relative z-[2] w-full px-[5%] max-w-[1400px] mx-auto">
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div className="max-w-[700px]">
              ...
              {/* Subheading */}
              <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-6 md:mb-8 max-w-[480px] text-white/75 reveal reveal-delay-2">
            ...
            <div className="relative hidden lg:block reveal reveal-delay-2">
              <div className="relative">
                ...
                />
                {/* Image Overlay */}
                <div className="absolute inset-0 bg-gradient-to-l from-navy/20 to-transparent pointer-events-none" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-8 md:bottom-12 right-[5%] z-[2] hidden md:flex gap-6 lg:gap-10">
          <div className="text-right">
            ...
            <span className="mt-1 block text-[0.65rem] font-medium uppercase tracking-[0.12em] text-gray-mid">
              Jenis Layanan
            </span>
          </div>
          <div className="text-right">
        ...
        <div className="absolute bottom-6 left-0 right-0 z-[2] flex justify-center gap-6 px-[5%] md:hidden">
          <div className="text-center">
            ...
            <span className="mt-1 block text-[0.55rem] font-medium uppercase tracking-[0.12em] text-white/60">
              Jenis Layanan
            </span>
          </div>
          <div className="text-center">
      ...
      {/* Services Section */}
      <section id="layanan" className="section-padding bg-navy-dark">
        <div className="mx-auto px-[5%] max-w-[1400px]">
          ...
          <div className="mb-8 md:mb-12 flex flex-col md:flex-row md:flex-wrap items-start md:items-end justify-between gap-4 md:gap-6">
            <div>
              ...
              <h2 className="text-[1.75rem] sm:text-[2rem] md:text-3xl lg:text-4xl xl:text-5xl font-black leading-[1.15] mb-2 md:mb-3 reveal reveal-delay-1">
                Layanan <span className="text-orange">Unggulan</span>
              </h2>
              <p className="text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed reveal reveal-delay-2 max-w-[500px] text-white/70">
          ...
          <div className="grid gap-[1px] md:gap-[1.5px] bg-orange/8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {/* Neon Box */}
            <div className="group relative overflow-hidden bg-navy p-5 sm:p-6 md:p-8 lg:p-9 transition-all duration-300 hover:bg-[#0d2240] cursor-pointer reveal">
              ...
              <h3 className="mb-1.5 sm:mb-2 text-xs sm:text-sm md:text-base font-bold tracking-tight">Neon Box</h3>
              <p className="text-[0.7rem] sm:text-[0.75rem] md:text-[0.82rem] leading-relaxed text-white/50">
            ...
            {/* Huruf Timbul */}
            <div className="group relative overflow-hidden bg-navy p-5 sm:p-6 md:p-8 lg:p-9 transition-all duration-300 hover:bg-[#0d2240] cursor-pointer reveal reveal-delay-1">
              <div className="absolute bottom-0 left-0 h-[2px] w-0 bg-orange transition-[width] duration-350 ease-out group-hover:w-full" />
              <div className="mb-3 sm:mb-4 md:mb-5 flex h-9 w-9 sm:h-10 sm:w-10 md:h-12 md:w-12 items-center justify-center border-[1.5px] border-orange/30 transition-all group-hover:border-orange group-hover:bg-orange/10">
                <svg viewBox="0 0 24 24" className="h-3 w-3 sm:h-3.5 sm:w-3.5 md:h-4 md:w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 stroke-orange fill-none" strokeWidth={1.8}>
              ...
              <h3 className="mb-1.5 sm:mb-2 text-xs sm:text-sm md:text-base font-bold tracking-tight">Huruf Timbul</h3>
              <p className="text-[0.7rem] sm:text-[0.75rem] md:text-[0.82rem] leading-relaxed text-white/50">
            ...
            {/* Billboard */}
            <div className="group relative overflow-hidden bg-navy p-5 sm:p-6 md:p-8 lg:p-9 transition-all duration-300 hover:bg-[#0d2240] cursor-pointer reveal reveal-delay-2">
              <div className="absolute bottom-0 left-0 h-[2px] w-0 bg-orange transition-[width] duration-350 ease-out group-hover:w-full" />
              <div className="mb-3 sm:mb-4 md:mb-5 flex h-9 w-9 sm:h-10 sm:w-10 md:h-12 md:w-12 items-center justify-center border-[1.5px] border-orange/30 transition-all group-hover:border-orange group-hover:bg-orange/10">
                <svg viewBox="0 0 24 24" className="h-3 w-3 sm:h-3.5 sm:w-3.5 md:h-4 md:w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 stroke-orange fill-none" strokeWidth={1.8}>
              ...
              <h3 className="mb-1.5 sm:mb-2 text-xs sm:text-sm md:text-base font-bold tracking-tight">Billboard</h3>
              <p className="text-[0.7rem] sm:text-[0.75rem] md:text-[0.82rem] leading-relaxed text-white/50">
            ...
            <div className="group relative overflow-hidden bg-navy p-5 sm:p-6 md:p-8 lg:p-9 transition-all duration-300 hover:bg-[#0d2240] cursor-pointer reveal">
              ...
              <h3 className="mb-1.5 sm:mb-2 text-xs sm:text-sm md:text-base font-bold tracking-tight">Reklame</h3>
              <p className="text-[0.7rem] sm:text-[0.75rem] md:text-[0.82rem] leading-relaxed text-white/50">
            ...
            <div className="group relative overflow-hidden bg-navy p-5 sm:p-6 md:p-8 lg:p-9 transition-all duration-300 hover:bg-[#0d2240] cursor-pointer reveal reveal-delay-1">
              ...
              <h3 className="mb-1.5 sm:mb-2 text-xs sm:text-sm md:text-base font-bold tracking-tight">Pylon Sign</h3>
              <p className="text-[0.7rem] sm:text-[0.75rem] md:text-[0.82rem] leading-relaxed text-white/50">
            ...
            <div className="group relative overflow-hidden bg-navy p-5 sm:p-6 md:p-8 lg:p-9 transition-all duration-300 hover:bg-[#0d2240] cursor-pointer reveal reveal-delay-2">
              ...
              <h3 className="mb-1.5 sm:mb-2 text-xs sm:text-sm md:text-base font-bold tracking-tight">Backdrop</h3>
              <p className="text-[0.7rem] sm:text-[0.75rem] md:text-[0.82rem] leading-relaxed text-white/50">
            ...
            <div className="group relative overflow-hidden bg-navy p-5 sm:p-6 md:p-8 lg:p-9 transition-all duration-300 hover:bg-[#0d2240] cursor-pointer reveal">
              ...
              <h3 className="mb-1.5 sm:mb-2 text-xs sm:text-sm md:text-base font-bold tracking-tight">Relling & Kanopi</h3>
              <p className="text-[0.7rem] sm:text-[0.75rem] md:text-[0.82rem] leading-relaxed text-white/50">
            ...
            <div className="group relative overflow-hidden bg-navy p-5 sm:p-6 md:p-8 lg:p-9 transition-all duration-300 hover:bg-[#0d2240] cursor-pointer reveal reveal-delay-1">
              ...
              <h3 className="mb-1.5 sm:mb-2 text-xs sm:text-sm md:text-base font-bold tracking-tight">Pagar Besi</h3>
              <p className="text-[0.7rem] sm:text-[0.75rem] md:text-[0.82rem] leading-relaxed text-white/50">
      ...
      {/* Why Us Section */}
      <section id="mengapa" className="section-padding relative overflow-hidden bg-navy">
        {/* Decorative Glow */}
        ...
        <div className="mx-auto px-[5%]">
          <div className="grid items-start gap-10 md:gap-16 lg:grid-cols-[1fr_1.1fr]">
            ...
            <div>
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-black leading-[1.15] mb-6 md:mb-10 reveal reveal-delay-1">
                Mengapa Memilih <span className="text-orange">Nara Sena?</span>
              </h2>

              <div className="space-y-3">
                {/* Item 1 */}
                <div className="group flex gap-5 border-l-2 border-transparent bg-white/[0.02] p-6 transition-all hover:border-orange hover:bg-orange/5 reveal">
                  <span className="pt-1 text-[0.65rem] font-bold tracking-[0.1em] text-orange">01</span>
                  <div>
                    <p className="mb-1 text-[0.92rem] font-bold">Pengerjaan Profesional & Terstandar</p>
                ...
                {/* Item 2 */}
                <div className="group flex gap-5 border-l-2 border-transparent bg-white/[0.02] p-6 transition-all hover:border-orange hover:bg-orange/5 reveal reveal-delay-1">
                  <span className="pt-1 text-[0.65rem] font-bold tracking-[0.1em] text-orange">02</span>
                  <div>
                    <p className="mb-1 text-[0.92rem] font-bold">Material Premium, Harga Bersaing</p>
                    <p className="text-[0.8rem] leading-relaxed text-white/50">
                ...
                {/* Item 3 */}
                <div className="group flex gap-5 border-l-2 border-transparent bg-white/[0.02] p-6 transition-all hover:border-orange hover:bg-orange/5 reveal reveal-delay-2">
                  <span className="pt-1 text-[0.65rem] font-bold tracking-[0.1em] text-orange">03</span>
                  <div>
                    <p className="mb-1 text-[0.92rem] font-bold">Garansi & After-Sales Service</p>
                    <p className="text-[0.8rem] leading-relaxed text-white/50">
                ...
                {/* Item 4 */}
                <div className="group flex gap-5 border-l-2 border-transparent bg-white/[0.02] p-6 transition-all hover:border-orange hover:bg-orange/5 reveal reveal-delay-3">
                  <span className="pt-1 text-[0.65rem] font-bold tracking-[0.1em] text-orange">04</span>
                  <div>
                    <p className="mb-1 text-[0.92rem] font-bold">Desain Gratis & Konsultasi Awal</p>
                    <p className="text-[0.8rem] leading-relaxed text-white/50">
            ...
            <div className="reveal reveal-delay-2">
              <p className="text-[0.95rem] md:text-[1.05rem] leading-relaxed mb-6 md:mb-8 text-white/80">
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-5 mb-6 md:mb-8">
                {/* Card 1 */}
                <div className="group relative overflow-hidden bg-gradient-to-br from-white/[0.04] to-white/[0.02] border border-white/[0.05] p-5 md:p-7 transition-all hover:border-orange/30 hover:bg-white/[0.06]">
                  ...
                  <div className="relative">
                    <p className="mb-1 md:mb-2 text-3xl md:text-4xl font-black leading-none text-white">
                      100<span className="text-orange">+</span>
                    </p>
                    <p className="text-[0.62rem] md:text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-white/60">
                      Proyek Selesai
                    </p>
                  </div>
                </div>
                ...
                {/* Card 2 */}
                <div className="group relative overflow-hidden bg-gradient-to-br from-white/[0.04] to-white/[0.02] border border-white/[0.05] p-7 transition-all hover:border-orange/30 hover:bg-white/[0.06]">
                  ...
                  <div className="relative">
                    <p className="mb-2 text-4xl font-black leading-none text-white">
                      5<span className="text-orange">+</span>
                    </p>
                    <p className="text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-white/60">
                      Tahun Pengalaman
                    </p>
                  </div>
                </div>
      ...
      {/* Portfolio Section */}
      <section id="portofolio" className="section-padding bg-navy-dark">
        <div className="mx-auto px-[5%]">
          {/* Portfolio Header */}
          <div className="mb-8 md:mb-12 flex flex-col md:flex-row md:flex-wrap items-start md:items-end justify-between gap-4 md:gap-6">
            <div>
              <p className="eyebrow mb-3 md:mb-4 reveal">Hasil Kerja Kami</p>
              <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-black leading-[1.15] reveal reveal-delay-1">
          ...
          <div className="grid gap-[1.5px] md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="group relative h-[480px] cursor-pointer overflow-hidden bg-gray md:row-span-2 reveal">
              <div className="flex h-full flex-col items-center justify-center gap-3 bg-gradient-to-br from-[#1a2f4a] to-[#0d1f35] transition-all group-hover:brightness-60">
                <svg viewBox="0 0 24 24" className="h-10 w-10 stroke-orange/40 fill-none" strokeWidth={1.5}>
                  <rect x="2" y="6" width="20" height="12" rx="1"/>
                  <path d="M6 10h12M6 14h8"/>
                </svg>
                <span className="text-[0.75rem] font-semibold uppercase tracking-[0.12em] text-white/25">
                  Neon Box – Resto Bandung
                </span>
              </div>
              <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-navy/95 to-transparent p-6 opacity-0 transition-opacity group-hover:opacity-100 lg:opacity-100">
                <p className="text-[0.62rem] font-semibold uppercase tracking-[0.15em] text-orange">Neon Box</p>
                <p className="text-base font-bold">Restoran Modern Bandung</p>
              </div>
            </div>
            ...
            <div className="group relative h-60 cursor-pointer overflow-hidden bg-gray reveal reveal-delay-1">
              ...
              <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-navy/95 to-transparent p-6 opacity-0 transition-opacity group-hover:opacity-100 lg:opacity-100">
                ...
                <p className="text-base font-bold">Kantor Pusat Jakarta</p>
              </div>
            </div>
            ...
            <div className="group relative h-60 cursor-pointer overflow-hidden bg-gray reveal reveal-delay-2">
              ...
              <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-navy/95 to-transparent p-6 opacity-0 transition-opacity group-hover:opacity-100 lg:opacity-100">
                ...
                <p className="text-base font-bold">Jalan Protokol Bogor</p>
              </div>
            </div>
            ...
            <div className="group relative h-60 cursor-pointer overflow-hidden bg-gray reveal reveal-delay-1">
              ...
              <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-navy/95 to-transparent p-6 opacity-0 transition-opacity group-hover:opacity-100 lg:opacity-100">
                ...
                <p className="text-base font-bold">Pusat Perbelanjaan Depok</p>
              </div>
            </div>
            ...
            <div className="group relative h-60 cursor-pointer overflow-hidden bg-gray reveal reveal-delay-2">
              ...
              <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-navy/95 to-transparent p-6 opacity-0 transition-opacity group-hover:opacity-100 lg:opacity-100">
                ...
                <p className="text-base font-bold">Toko Ritel Bogor Selatan</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Process Section */}
      <section id="proses" className="section-padding bg-navy">
        <div className="mx-auto px-[5%]">
          <div className="mb-2 text-center">
            <p className="eyebrow mb-3 md:mb-4 reveal mx-auto">Cara Kerja Kami</p>
            <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-black leading-[1.15] reveal reveal-delay-1 mx-auto">
          ...
          <div className="relative mt-10 md:mt-14 grid gap-8 md:grid-cols-2 lg:grid-cols-4 lg:gap-0">
            ...
            <div className="reveal text-center px-4">
              <div className="relative z-[1] mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-full border-[1.5px] border-orange/40 bg-navy transition-all group-hover:border-orange group-hover:bg-orange/10">
                <MessageCircle className="h-6 w-6 stroke-orange" strokeWidth={1.8} />
                <span className="absolute -right-1.5 -top-1.5 flex h-5 w-5 items-center justify-center rounded-full bg-orange text-[0.6rem] font-extrabold">1</span>
              </div>
              <h3 className="mb-2 text-[0.9rem] font-bold">Konsultasi</h3>
            ...
            <div className="reveal reveal-delay-1 text-center px-4">
              <div className="relative z-[1] mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-full border-[1.5px] border-orange/40 bg-navy transition-all group-hover:border-orange group-hover:bg-orange/10">
                ...
                <span className="absolute -right-1.5 -top-1.5 flex h-5 w-5 items-center justify-center rounded-full bg-orange text-[0.6rem] font-extrabold">2</span>
              </div>
              <h3 className="mb-2 text-[0.9rem] font-bold">Desain & Mock-up</h3>
              <p className="text-[0.78rem] leading-relaxed text-white/45">
            ...
            <div className="reveal reveal-delay-2 text-center px-4">
              <div className="relative z-[1] mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-full border-[1.5px] border-orange/40 bg-navy transition-all group-hover:border-orange group-hover:bg-orange/10">
                ...
                <span className="absolute -right-1.5 -top-1.5 flex h-5 w-5 items-center justify-center rounded-full bg-orange text-[0.6rem] font-extrabold">3</span>
              </div>
              <h3 className="mb-2 text-[0.9rem] font-bold">Produksi</h3>
              <p className="text-[0.78rem] leading-relaxed text-white/45">
            ...
            <div className="reveal reveal-delay-3 text-center px-4">
              <div className="relative z-[1] mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-full border-[1.5px] border-orange/40 bg-navy transition-all group-hover:border-orange group-hover:bg-orange/10">
                ...
                <span className="absolute -right-1.5 -top-1.5 flex h-5 w-5 items-center justify-center rounded-full bg-orange text-[0.6rem] font-extrabold">4</span>
              </div>
              <h3 className="mb-2 text-[0.9rem] font-bold">Pemasangan</h3>
              <p className="text-[0.78rem] leading-relaxed text-white/45">
      ...
      <section id="kontak" className="relative overflow-hidden bg-gradient-to-br from-orange to-[#e85500] py-16 md:py-20">
        {/* Decorative Circle */}
        <div className="pointer-events-none absolute -right-[10%] -top-[50%] h-[600px] w-[600px] rounded-full bg-white/[0.06]" />
        ...
        <div className="relative z-[1] mx-auto px-[5%]">
          <div className="flex flex-col items-start justify-between gap-6 md:gap-8 lg:flex-row lg:items-center">
            <div>
              <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-black leading-[1.15] mb-2 md:mb-3 max-w-xl">
